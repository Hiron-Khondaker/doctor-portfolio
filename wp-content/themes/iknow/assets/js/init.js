...
function iknow_tm_versubmenu() {

    jQuery(".iknow_tm_mobile_menu_extra .dropdown a").on('click', function() {
        var e = jQuery(this);
        var p = e.closest('li');
...
function iknow_tm_trigger_menu() {
    ...
    var hamburger = jQuery('.iknow_tm_mobile_menu .trigger .hamburger,.iknow_tm_mobile_menu_extra .trigger .hamburger');
    var mobileMenu = jQuery('.iknow_tm_mobile_menu .dropdown,.iknow_tm_mobile_menu_extra .dropdown');
...
function iknow_tm_submenu() {

    var WW = jQuery(window).width();
    var submenu = jQuery('.iknow_tm_simple_header .sub-menu');
...
function iknow_tm_page_title_margin() {
    "use strict";

    var ww = jQuery(window).width();
    var header = jQuery('.iknow_tm_simple_header').outerHeight(true);
    var mobMenu = jQuery('.iknow_tm_mobile_menu_extra').outerHeight();
    var title = jQuery('.iknow_tm_page_title');
    var portfolioImage = jQuery('.iknow_tm_portfolio_single .main_image');
    var serviceImage = jQuery('.iknow_tm_service_single .main_image');
    ...
    if (ww >= 1040) {
        ...
        title.css({
            marginTop: mobMenu + 'px'
        });
        portfolioImage.css({
            marginTop: (mobMenu + 50 + 'px')
        });
        serviceImage.css({
            marginTop: (mobMenu + 50 + 'px')
        });
